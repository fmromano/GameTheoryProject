...
These algorithms were compared in three tests.  For each test, 
a set of randomly defined inputs were entered into each algorithm 
for each iteration.  During these iterations, the metrics were sampled, 
averaged, and stored until all of the runs were finished.  All random
...
The number of simulations represents how many runs the comparison 
...
the minimum and maximum number of different cores types that would be 
...
The speed ratios parameter decided how fast each job would be on every core type.
...
%[1]Y. Jiang, X. Shen, J. Chen, and R. Tripathi,\mathbf{ }��Analysis and Approximation of Optimal Co-scheduling on Chip Multiprocessors\mathbf{,}�� in Proceedings of the 17th International Conference on Parallel Architectures and Compilation Techniques, New York, NY, USA, 2008, pp. 22\mathbf{0}��229.
%[2]D. Gale and L. S. Shapley,\mathbf{ }��College Admissions and the Stability of Marriage\mathbf{,}�� The American Mathematical Monthly, vol. 69, no. 1, p. 9, Jan. 1962.
%[3\mathbf{]}��College Admissions and the Stability of Marriage on JSTOR\mathbf{.}�� .
%[4]C. P. J. Adolphs and P. Berenbrink,\mathbf{ }��Distributed Selfish Load Balancing with Weights and Speeds\mathbf{,}�� in Proceedings of the 2012 ACM Symposium on Principles of Distributed Computing, New York, NY, USA, 2012, pp. 13\mathbf{5}��144.
%[5]H. Xu and B. Li,\mathbf{ }��Egalitarian stable matching for VM migration in cloud computing\mathbf{,}�� in 2011 IEEE Conference on Computer Communications Workshops (INFOCOM WKSHPS), 2011, pp. 63\mathbf{1}��636.
%[6]D. F. Manlove, R. W. Irving, K. Iwama, S. Miyazaki, and Y. Morita,\mathbf{ }��Hard variants of stable marriage\mathbf{,}�� Theoretical Computer Science, vol. 276, no. \mathbf{1}��2, pp. 26\mathbf{1}��279, Apr. 2002.
%[7]H. Xu and B. Li,\mathbf{ }��Seen as stable marriages\mathbf{,}�� in 2011 Proceedings IEEE INFOCOM, 2011, pp. 58\mathbf{6}��590.
%[8]A. E. Roth,\mathbf{ }��Stability and Polarization of Interests in Job Matching\mathbf{,}�� Econometrica, vol. 52, no. 1, p. 47, Jan. 1984.
%[9\mathbf{]}��Stability and Polarization of Interests in Job Matching on JSTOR\mathbf{.}�� .
%[10]X. Wen, K. Chen, Y. Chen, Y. Liu, Y. Xia, and C. Hu,\mathbf{ }��VirtualKnotter: Online Virtual Machine Shuffling for Congestion Resolving in Virtualized Datacenter\mathbf{,}�� in 2012 IEEE 32nd International Conference on Distributed Computing Systems (ICDCS), 2012, pp. 1\mathbf{2}��21.
%[11]J. S. Dhillon, S. Purini, and S. Kashyap,\mathbf{ }��Virtual Machine Coscheduling: A Game Theoretic Approach\mathbf{,}�� in 2013 IEEE/ACM 6th International Conference on Utility and Cloud Computing (UCC), 2013, pp. 22\mathbf{7}��234.
