...
In this comparison case, the simple matching performed worse compared to 
...
For this comparison, the second deferred acceptance algorithm does as well as or
 better than the other algorithms.  The proposed algorithm and the first deferred
...
For this case, the second deferred acceptance algorithm performed the best in
 everything except percent jobs assigned and average resource score.  The first 
...
job completion compared to the others.  The second deferred acceptance
 ...
 the proposed algorithm measuring close to it.  The simple matching
 algorithm performed normally as well as the first deferred algorithm.  
Its main weakness was that it normally did not match all of the available
 jobs, which would make users very unhappy.
