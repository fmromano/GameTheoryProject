...
A note:  the math needs to be cleaned up.  In order to save time,
editing the equations will happen last.
...
the two agent sets are men and women, whose sets
are 
...
rational, a matched set will be stable.

\emph{Theorem 1}:  A stable matching pair exists for every marriage market.

This theorem was proposed and solved by Gale and Shapley
by using their deferred acceptance algorithm.
